...
export const About = () => {
  return (
    <section id="about" className="min-h-screen flex items-center justify-center py-24 bg-modern-dark">
      <RevealOnScroll>
        <div className="max-w-4xl mx-auto px-4">
          <SpotlightCard className="text-center">
            <h2 className="text-4xl font-bold bg-gradient-to-r from-blue-500 to-cyan-400 bg-clip-text text-transparent mb-6">
              About Me
            </h2>
            ...
            <div className="mt-12">
              <h3 className="text-xl font-bold text-white mb-8">My Skillset</h3>
              <div className="flex justify-center flex-wrap gap-x-8 gap-y-6">
                {skills.map((skill) => (
                  // PERUBAHAN 1: Kita beri nama group ini "skill"
                  <div key={skill.name} className="group/skill flex flex-col items-center justify-center text-center w-24">
                    <div
                      // PERUBAHAN 2: Kita panggil nama group-nya secara spesifik
                      className="text-4xl text-gray-400 group-hover/skill:text-cyan-400 transition-all duration-300 group-hover/skill:scale-110 group-hover/skill:-translate-y-1"
                    >
                      {skill.icon}
                    </div>
                    <span
                      // PERUBAHAN 3: Lakukan hal yang sama untuk teks namanya
