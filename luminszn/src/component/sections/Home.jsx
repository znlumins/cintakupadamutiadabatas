...
// Link gambar yang stabil
const galleryImages = [
  {
    src: 'https://i.ibb.co/CprX459S/2025-02-18-11-33-IMG-0281.jpg?q=80&w=1648&auto=format=fit=crop',
    alt: 'Abstract dark background with glowing tech lines'
  },
  {
    src: 'https://i.ibb.co/Txfxy9sn/DSC00825.jpg?q=80&w=1648&auto=format=fit',
...
export const Home = () => {
  ...
  return (
    <>
      ...
      <section
        id="home"
        className="final-bg min-h-screen flex items-center overflow-hidden py-20"
        style={{'--mouse-x': `${mousePosition.x}px`, '--mouse-y': `${mousePosition.y}px`}}
      >
        <div className="relative z-10 max-w-7xl mx-auto px-4 w-full">
          {/* === PERUBAHAN DI SINI: Mengurangi 'gap' untuk mobile === */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-center">
            ...
            >
              <div className="p-4 sm:p-8 text-center md:text-left">
                {/* === PERUBAHAN DI SINI: Ukuran font responsif === */}
                <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold mb-3 md:mb-4 bg-gradient-to-r from-blue-500 to-purple-600 bg-clip-text text-transparent">
                  Hi, I'm znlumins.
                </h1>

                {/* === PERUBAHAN DI SINI: Menghapus 'hidden' agar terlihat di mobile === */}
                <p className="text-gray-400 text-sm lg:text-base mb-8 max-w-xl mx-auto md:mx-0">
                ...
                <div className="flex flex-row justify-center md:justify-start items-center space-x-4 sm:space-x-6">
                  {/* === PERUBAHAN DI SINI: Padding dan ukuran teks tombol responsif === */}
                  <a href="#projects" className="bg-blue-600 text-white py-2 px-6 sm:py-3 sm:px-8 rounded-full font-semibold text-base sm:text-lg transition-all duration-500 ease-out transform hover:scale-110 hover:bg-blue-700">View Projects</a>
                  <a href="#contact" className="border-2 border-white text-white py-2 px-6 sm:py-3 sm:px-8 rounded-full font-semibold text-base sm:text-lg transition-all duration-500 ease-out transform hover:scale-110 hover:bg-white hover:text-gray-900">Contact Me</a>
                </div>
              </div>
            </div>
