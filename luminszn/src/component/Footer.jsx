...
import {
    ...
    FaDownload, FaSync, FaPhotoVideo, FaReact, FaNodeJs, FaFigma, FaGitAlt
} from "react-icons/fa";
// Icon-icon baru untuk tech stack
import { SiJavascript, SiTailwindcss, SiNextdotjs, SiVercel, SiPrisma } from "react-icons/si";

// --- KOMPONEN BARU YANG BERGUNA: TECH STACK TICKER ---
// Komponen ini menggantikan GitHubActivityTicker
const TechStackTicker = () => {
  // Data untuk tech stack, bisa Anda kustomisasi sesuai keahlian Anda
  // Anda bisa mencari ikon lain dari library 'react-icons'
  const techData = [
  ...
  return (
    <div className="flex items-center">
      {techData.map((tech) => (
        <div key={tech.name} className="flex items-center mx-8 whitespace-nowrap text-gray-300 hover:text-white transition-colors cursor-default">
          <tech.Icon className="w-6 h-6 mr-3" style={{ color: tech.color }} />
...
// --- DATA-DATA & KOMPONEN LAINNYA (TETAP SAMA) ---
const socialLinks = [
  ...
  return (
    <footer className="bg-white dark:bg-gray-900">
      <div className="py-3 bg-gray-900/80 backdrop-blur-sm border-y border-gray-700/50 overflow-hidden">
        ...
        <Marquee gradient={true} gradientColor={[17, 24, 39]} gradientWidth={50} speed={40} pauseOnHover={true}>
          {/* Menggunakan komponen TechStackTicker yang baru */}
          <TechStackTicker />
          {/* Duplikat untuk loop yang mulus */}
          <TechStackTicker /> 
        </Marquee>
      </div>
